...
const databaseFile = "./database/appdata.sqlite";
//const databaseFile3 = new sqlite3.Database(path.resolve(__dirname, 'appdata.db'));
// const databaseFile = new sqlite3.Database("appdata.db", (err) => {
//   if (err) {
